...
public class ManipuladorVariavel implements ManipuladorLua, Serializable {
    ...
    public void addline(String line) {
        ...
        for (int i = 0; parts.length > i; i++) {
            ...
            //Separação das variaveis de seus resultados
        }
        ...
        for (int i = 0; ListaR.toArray().length > i; i++) {
            ...
            //entrada do usuario e tratamento dos dados
            if (ListaR.get(i).compareTo("nil") == 0) {
                aux = new ValString(null, "null", ListaV.get(i));
                //testa se é nulo
            } else if (ListaR.get(i).charAt(0) == '\''
                    || ListaR.get(i).charAt(0) == '\"') {
                ...
                //faz operações basicas aritmetricas e testa se é um numero ou operação
            } else {
        ...
        /*  for (int i = 0; ListaOV.toArray().length > i; i++) {
            System.out.println(ListaOV.get(i));
            //teste de lista
        }*/
        ListaR.clear();
        ListaV.clear();
    ...
    public ValDouble subtracao(int i) {
        ...
        double m = 0;
        if (!Multi[0].isEmpty()
                && Character.isAlphabetic(Multi[0].charAt(0))) {
            for (int k = 0; ListaOV.toArray().length > k; k++) {
