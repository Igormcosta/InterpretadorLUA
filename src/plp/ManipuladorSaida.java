...
public class ManipuladorSaida implements ManipuladorLua {
    ...
    public void addline(String line) {
        ...
        if (linhaPrint.contains("\'") || linhaPrint.contains("\"")) {
            System.out.println((linhaPrint.contains("\'") ? linhaPrint.replaceAll("\'", "") : linhaPrint.replaceAll("\"", "")));
            ...
            if (linhaPrint.contains("*")
                    ...
                    || linhaPrint.contains("/")
                    || linhaPrint.contains("-")
                    || Character.isDigit(linhaPrint.charAt(0))) {
                if (linhaPrint.contains(".")) {
                    if (linhaPrint.contains("*")) {
            ...
            //separação de tipos
            //se n for um digito sera uma variavel
        } else {
            //se for um dgito printa direto
